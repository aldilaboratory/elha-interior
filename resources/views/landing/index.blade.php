                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3 col-7">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="{{asset('assets_landing/images/logo/logo.svg')}}" alt="Logo">
                        </a>
                        <!-- End Header Logo -->
                    </div>
                                    ...
                                    <div class="shopping-item">
                                        ...
                                        <ul class="shopping-list">
                                            <li>
                                                ...
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="product-details.html"><img
                                                            src="{{asset('assets_landing/images/header/cart-items/item1.jpg')}}" alt="#"></a>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="product-details.html"><img
                                                            src="{{asset('assets_landing/images/header/cart-items/item2.jpg')}}" alt="#"></a>
                                                </div>
                                                <div class="content">
                    ...
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider"
                                style="background-image: url({{asset('assets_landing/images/hero/slider-bg1.jpg')}});">
                                <div class="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-1.jpg')}}" alt="#">
                            <div class="button">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-2.jpg')}}" alt="#">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-3.jpg')}}" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-4.jpg')}}" alt="#">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-5.jpg')}}" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-6.jpg')}}" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-7.jpg')}}" alt="#">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('assets_landing/images/products/product-8.jpg')}}" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('{{asset('assets_landing/images/banner/banner-1-bg.jpg')}}');">
                        <div class="content">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin"
                        style="background-image: url('{{ asset('assets_landing/images/banner/banner-2-bg.jpg') }}');">
                        <div class="content">
