...
@section('content')
    <div class="breadcrumb">
        ...
        <ul>
            ...
            <li>Edit Transaksi Detail</li>
        </ul>
    </div>
    <div class="separator-breadcrumb border-top"></div>
    <div class="card">
        <div class="card-body">
            <form action="{{ route('transaksi_detail.update', $transaksi_detail->id) }}" method="post"
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="transaksi_id" id="transaksi_id"
                                value="{{ old('transaksi_id') ? old('transaksi_id') : $transaksi_detail->transaksi_id }}">
                            @error('transaksi_id')
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="produk_id" id="produk_id"
                                value="{{ old('produk_id') ? old('produk_id') : $transaksi_detail->produk_id }}">
                            @error('produk_id')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="harga" id="harga"
                                value="{{ old('harga') ? old('harga') : $transaksi_detail->harga }}">
                            @error('harga')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
