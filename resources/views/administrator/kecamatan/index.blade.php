...
@section('content')
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('kecamatan.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
        ...
        $('table').DataTable({
            ...
            createdRow: function(row, data) {
                $(".action-edit", row).click(function(e) {
                    const url = baseUrl('/kecamatan/' + data.id + '/edit');
