...
<div class="d-none">
    <form id="form-destroy" action="{{ route('produk.store') }}" method="post">
        @csrf
        @method('DELETE')
    </form>
</div>
    ...
    $('table').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    if (data) {
                        return `<img src="/upload/produk/${data}" alt="${row.nama}" style="width:160px; height:auto;">`;
                    } else {
        ...
        createdRow: function(row, data) {
            $(".action-edit", row).click(function(e) {
                const url = baseUrl('/produk/' + data.id + '/edit');
