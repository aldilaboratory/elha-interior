...
@section('content')
    <div class="breadcrumb justify-content-between">
        ...
        <div>
            <a href="{{ route('kab_kota.create') }}" class="btn btn-success">
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('kab_kota.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
        ...
        $('table').DataTable({
            ...
            createdRow: function(row, data) {
                $(".action-edit", row).click(function(e) {
                    const url = baseUrl('/kab_kota/' + data.id + '/edit');
