...
<div class="breadcrumb">
    ...
    <ul>
        ...
        <li>Edit Banner Promosi</li>
    </ul>
</div>
<div class="separator-breadcrumb border-top"></div>
<div class="card">
    <div class="card-body">
        <form action="{{ route('bannerpromosi.update', $bannerPromosi->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="text-center">
                        <div class="image-upload-container position-relative d-inline-block">
                            <img id="preview-image"
                                src="{{ $bannerPromosi->image ? asset('upload/bannerpromosi/' . $bannerPromosi->image) : asset('assets/images/placeholder.jpg') }}"
                                alt="Preview Gambar"
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-12">
                    ...
                    <input class="form-control form-control-lg"
                        ...
                        value="{{ old('nama', $bannerPromosi->nama) }}">
                    @error('nama')
                    <div class="text-danger mt-1">
                        <small><i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}</small>
                    </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control"
                        ...
                        id="deskripsi"
                        rows="4"
                        placeholder="Masukkan deskripsi produk...">{{ old('deskripsi', $bannerPromosi->deskripsi) }}</textarea>
                    @error('deskripsi')
                    <div class="text-danger mt-1">
                        <small><i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}</small>
                    </div>
