...
<div class="breadcrumb">
    <h1 class="mr-2">Footer Promosi</h1>
    <ul>
        <li>
            <a href="#">Home</a>
        </li>
        <li>Edit Footer Promosi</li>
    </ul>
</div>
<div class="separator-breadcrumb border-top"></div>
<div class="card">
    <div class="card-body">
        <form action="{{ route('footerpromosi.update', $footerPromosi->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="text-center">
                        <div class="image-upload-container position-relative d-inline-block">
                            <img id="preview-image"
                                src="{{ $footerPromosi->image ? asset('upload/footerpromosi/' . $footerPromosi->image) : asset('assets/images/placeholder.jpg') }}"
                                alt="Preview Gambar"
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    ...
                    <input class="form-control form-control-lg"
                        ...
                        value="{{ old('nama', $footerPromosi->nama) }}">
                    @error('nama')
                    <div class="text-danger mt-1">
                        <small><i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}</small>
                    </div>
                ...
                <div class="col-6 mb-3">
                    ...
                    <select class="form-select form-select-lg select2" name="produk_id" id="produk_id" style="width: 100%;">
                        <option value="">-- Pilih produk --</option>
                        @foreach($produk as $val)
                        <option value="{{ $val->id }}"
                            {{ old('produk_id', $val->produk_id) == $val->produk_id ? 'selected' : '' }}>
                            {{ $val->nama }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control"
                        ...
                        id="deskripsi"
                        rows="4"
                        placeholder="Masukkan deskripsi...">{{ old('deskripsi', $footerPromosi->deskripsi) }}</textarea>
                    @error('deskripsi')
                    <div class="text-danger mt-1">
                        <small><i class="fas fa-exclamation-triangle me-1"></i>{{ $message }}</small>
                    </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="d-flex gap-3 justify-content-end">
                        <a href="{{ route('footerpromosi.index') }}" class="btn btn-outline-secondary btn-lg px-4 mr-2">
                            Kembali
                        </a>
