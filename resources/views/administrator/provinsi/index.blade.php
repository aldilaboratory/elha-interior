...
@section('content')
    <div class="breadcrumb justify-content-between">
        ...
        <div>
            <a href="{{ route('provinsi.create') }}" class="btn btn-success">
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('provinsi.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
        ...
        $('table').DataTable({
            ...
            createdRow: function(row, data) {
                $(".action-edit", row).click(function(e) {
                    const url = baseUrl('/provinsi/' + data.id + '/edit');
