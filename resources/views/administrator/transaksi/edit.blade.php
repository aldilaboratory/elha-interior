                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="user_id" id="user_id"
                                value="{{ old('user_id') ? old('user_id') : $transaksi->user_id }}">
                            @error('user_id')
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="metode_id" id="metode_id"
                                value="{{ old('metode_id') ? old('metode_id') : $transaksi->metode_id }}">
                            @error('metode_id')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-auto">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ekspedisi_id" id="ekspedisi_id"
                                value="{{ old('ekspedisi_id') ? old('ekspedisi_id') : $transaksi->ekspedisi_id }}">
                            @error('ekspedisi_id')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
